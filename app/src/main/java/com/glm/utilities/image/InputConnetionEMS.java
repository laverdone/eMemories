package com.glm.utilities.image;
 ...
 */
public class InputConnetionEMS extends BaseInputConnection{
    private PaperSurface mSurface;
    private final InputMethodManager mIMM;
    private final View mTargetView;
    public InputConnetionEMS(View targetView, boolean fullEditor) {
    ...
    public void setView(PaperSurface view) {
        mSurface = view;
    }
}
