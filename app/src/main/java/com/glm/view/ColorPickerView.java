...
public class ColorPickerView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mShowAlphaPanel = true;//a.getBoolean(R.styleable.ColorPickerView_alphaChannelVisible, false);
        mAlphaSliderText = "";//a.getString(R.styleable.ColorPickerView_alphaChannelText);
        mSliderTrackerColor = Color.BLACK;// a.getColor(R.styleable.ColorPickerView_colorPickerSliderColor, 0xFFBDBDBD);
        mBorderColor = Color.WHITE;// a.getColor(R.styleable.ColorPickerView_colorPickerBorderColor, 0xFF6E6E6E);
        //a.recycle();
